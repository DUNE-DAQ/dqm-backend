...
def compile_static_assets(assets):
    ...
    display_style_bundle = Bundle(
        "display_bp/less/display.less",
        filters="less,cssmin",
        output="dist/css/display.css",
        extra={"rel": "stylesheet/less"},
    )
    ...
    assets.register("display_style_bundle", display_style_bundle)
